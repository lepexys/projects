...
namespace kill
{
    ...
    class Person
    {
        ...
        {
            Magazine myMagazine = new Magazine("jurnal", Frequency.Weekly, new DateTime(1999, 10, 10), 60000);
            ...
            Magazine magazine = new Magazine("jurnal", Frequency.Weekly, new DateTime(1999, 10, 10), 60000);
            magazine.AddFromConsole();
            magazine.Save(Filename1);
            Console.WriteLine(magazine.ToString());
            Magazine.Load(Filename1, magazine);
            magazine.AddFromConsole();
            Magazine.Save(Filename1, magazine);
            Console.WriteLine("Введите Имя Файла");
            string Filename = Console.ReadLine();
            string dirName = @"C:\Users\Владик\source\repos\ITSYOURLASTCHANSE\kill\bin\Release";
